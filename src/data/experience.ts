...
export const experiences: WorkExperience[] = [
  ...
  },
  {
    ...
    description: {
      zh: [
        '需求梳理：走访 3 所学校、访谈 6 位教师，从反馈与客诉中提炼痛点，基于 RICE 模型完成需求评估',
        '产品迭代：参与业务逻辑优化，推动规则与特征相似度方案落地，批阅时长缩短 3 min，LLM 使用率降至 30%',
        '流程优化：搭建 workflow 与 Agent 覆盖高频盯盘场景，日均触发 50 次，释放人力并持续沉淀 SOP',
      ],
      en: [
  ...
  },
  {
    ...
    description: {
      zh: [
        '用户洞察：运用 JTBD 多渠道梳理 150+ 原生需求，归纳 3 大核心痛点与目标画像，形成内容策略与选题库',
        '活动策划：搭建运营框架、项目表、素材矩阵与裂变机制，多渠道测试后聚焦小红书高质量导流',
        '效果复盘：基于漏斗模型和 RICE 排序迭代，实现曝光 200,000+、私域拉新 100+，产出可复用 SOP',
      ],
      en: [
        'User Insights: Used JTBD to analyze 150+ original needs across channels, identified 3 core pain points & target personas, formed content strategy & topic library',
        'Campaign: Built operation framework, project plan, content matrix & viral mechanisms, focused on Xiaohongshu for quality traffic after multi-channel tests',
        'Results: Iterated via funnel model & RICE prioritization, achieved 200,000+ impressions, 100+ private domain conversions, produced reusable SOP',
      ],
    },
  ...
  },
  {
    ...
    description: {
      zh: [
        '店铺运营：负责 30+ SKU 选品、主图与 Banner 设计、ERP 调配，店铺月流量达 20,000+ UV，月订单超 50 单',
        '达人合作：通过精选联盟筛选尾部达人，累计带货 600+ 件，月 GMV 达 4,000+ 元，初步搭建达人带货矩阵',
        '数据优化：用电商罗盘跟踪 UV、CTR、加购率和支付率，对低转化 SKU 做 A/B 测试，转化率提升 3.9%',
      ],
      en: [
        'Store Ops: Managed 30+ SKU selection, main image/banner design, ERP coordination, reaching 20,000+ monthly UV and 50+ orders/month',
        'Influencers: Recruited micro-influencers via Jingxuan Alliance, driving 600+ cumulative sales and ¥4,000+ monthly GMV, built influencer sales matrix',
        'Optimization: Tracked UV, CTR, cart rate and payment rate via e-commerce compass, ran A/B tests that improved conversion by 3.9%',
      ],
    },
